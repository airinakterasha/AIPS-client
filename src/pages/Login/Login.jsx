  ...
  return (
    <>
      <div className="container mx-auto">
        <div className="text-center bg-warning mt-14 mb-24">
            <h1 className="md:text-4xl font-bold py-4 capitalize">Please login to your account</h1>
        </div>
        <div className="flex flex-col md:flex-row justify-between lg:px-10">
          {/* registration form container start */}
          <div className="flex-1">
            <h2 className="text-xl font-semibold text-center">Login by your email and password</h2>
          ...
          <div className="md:mt-14 ">
            {/* google */}
            <div className="w-full md:p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
              ...
              <div className="my-6 space-y-4">
                <button onClick={handleGoogleLogin} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="text-warning w-5 h-5 fill-current">
        ...
        <div className="text-center py-10">
            <p className="md:text-2xl">Do not have an account? Please <Link to='/registration' className="text-accent">Register</Link></p>
        </div>
      </div>
    </>
  )
