...
const Footer = () => {
  return (
    <footer className="py-6 dark:bg-gray-100 dark:text-gray-900">
        <hr className="" />
        <div className="container px-6 mx-auto space-y-3 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50 mt-14">
            <div className="grid grid-cols-12">
                <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center md:justify-start"> 
                        <span className="self-center text-3xl font-bold text-warning">AIPS</span>
                    </a>
                </div>           
            </div>
